# Kleinanzeigen Price Tracker

[![Bright Data](https://img.shields.io/badge/Powered%20by-Bright%20Data-blue?style=flat-square)](https://brightdata.de)
[![Kleinanzeigen Price Tracker](https://img.shields.io/badge/Kleinanzeigen%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/kleinanzeigen)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/kleinanzeigen)

Kleinanzeigen-Preisverfolgung in Echtzeit – Deutschlands größte Kleinanzeigenplattform. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit Bright Data's AI Scraper Builder.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/kleinanzeigen)** ist Bright Data's vollständig verwaltete Plattform für Retail Intelligence. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Kleinanzeigen-Preise überwachen** in allen Produktkategorien
...
> **Ab $250/Monat - [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/kleinanzeigen)**

---

## Option 2: Erstellen Sie Ihren eigenen Kleinanzeigen-Scraper

Keine vorgefertigte Kleinanzeigen-Scraper-API? Kein Problem. Bright Data's **AI Scraper Builder** generiert in nur wenigen Klicks einen benutzerdefinierten Kleinanzeigen-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren Kleinanzeigen-Scraper in wenigen Minuten

**[Öffnen Sie den Kleinanzeigen AI Scraper Builder →](https://brightdata.de/products/web-scraper/kleinanzeigen)**
...
Sobald Ihr Scraper erstellt ist, erhält Ihr Scraper eine **Web Scraper ID** (`gd_xxxxxxxxxxxx`) — kopieren Sie sie für den Setup-Schritt unten.
...
- Eine **Web Scraper ID** für Kleinanzeigen (aus dem obigen Build-Schritt)
...
1. **Dieses repository klonen**
   ...
   ```bash
   git clone https://github.com/bright-data-de/kleinanzeigen-price-tracker.git
   cd kleinanzeigen-price-tracker
   ```
...
3. **Zugangsdaten konfigurieren**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/kleinanzeigen)
...
Sobald Ihr Kleinanzeigen-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Kleinanzeigen-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.kleinanzeigen.de/product/sample-item-123456",
...
Sammeln Sie alle Produkte von einer Kleinanzeigen-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://kleinanzeigen.de/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.kleinanzeigen.de/product/sample-item-123456",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://kleinanzeigen.de/images/product1.jpg"],
...
inputs = [{"url": "https://www.kleinanzeigen.de/product/sample-item-123456"}]
...
- 🌟 [Kleinanzeigen Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/kleinanzeigen)
- 🏗️ [Einen Kleinanzeigen-Scraper erstellen](https://brightdata.de/products/web-scraper/kleinanzeigen)
